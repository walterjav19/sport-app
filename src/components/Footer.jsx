export default function Footer() {
  return (
    <footer className="bg-gray-900 dark:bg-white-900">
      <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-between">
          ...
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-1">
            <div>
              <h2 className="mb-6 text-sm font-semibold text-white-900 uppercase text-white">Legal</h2>
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2025 <a href="https://flowbite.com/" className="hover:underline">Walterjav™</a>. All Rights Reserved.
          </span>
          <div className="flex mt-4 sm:justify-center sm:mt-0">
            <a href="https://www.facebook.com/people/Walter-Javier/pfbid02qR4wPUvdeLqSQCWFjzk6pWs8LgMnkxQS861FhUkeDWzE695xqwn6J1cxaqE67Jsql/?mibextid=ZbWKwL" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
              <svg className="w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 8 19">
                <path fillRule="evenodd" d="M6.135 3H8V0H6.135a4.147 4.147 0 0 0-4.142 4.142V6H0v3h2v9.938h3V9h2.021l.592-3H5V3.591A.6.6 0 0 1 5.592 3h.543Z" clipRule="evenodd"/>
              </svg>
              <span className="sr-only">Facebook page</span>
            </a>
            <a href="https://www.instagram.com/walterjav19/" className="text-gray-500 hover:text-gray-900 dark:hover:text-white ms-5">
            ...
            <a href="https://github.com/walterjav19" className="text-gray-500 hover:text-gray-900 dark:hover:text-white ms-5">
